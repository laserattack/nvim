...
---- смотри lazy-lock.json

-- Команды/комбинации клавиш
...
---- p - вставить текст перед курсором (если скопирована строка через yy/dd то вставляет скопированную строку ниже текущей)
...
---- :noh - скрыть подсветку результатов
