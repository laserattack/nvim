...
- `alt+1` - перейти на предыдущую вкладку (можно использовать для циклического переключения между вкладками)
- `alt+2` - перейти на следующую вкладку (можно использовать для циклического переключения между вкладками)
...
- `el` - исполняет текущую строку как lua код

#### Работа с деревом директорий (netrw)

- `alt+e` - открыть дерево директорий
- `d` - создание папки
